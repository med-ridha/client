...
const kPrimaryColor = Color(0xFF3f407a);
const kSecondaryColor = Color(0xFF00a3af);
const kDarkGreyColor = Color(0xFF888989);
...
class DesignCourseAppTheme {
  ...
  static const Color nearlyBlue = Color(0xFF00a3af);
